...
-- instances; the schema must exist before any table can be created inside it.
...
CREATE UNIQUE INDEX "workflow_runs_source_event_id_idx" ON "agent"."workflow_runs" USING btree ("source_event_id");