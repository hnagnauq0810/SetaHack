...
export const INVENTORY: StatementSpec[] = [
  ...
  },
  {
    ...
    roles: [
      {
        slug: 'ld-reporting.bod',
        description: 'Read executive-level L&D summaries with sensitive learner data masked',
        permissions: [
          'ld-reporting.read',
      ...
      {
        slug: 'ld-reporting.manager',
        description: 'Run, review, and finalize L&D reporting workflows with learner-level access',
        permissions: [
          'ld-reporting.read',
          'ld-reporting.readiness.read',
      ...
      {
        slug: 'ld-reporting.team_manager',
        description: 'Read team/aggregate L&D views with learner-level masking',
        permissions: [
          'ld-reporting.read',
          'ld-reporting.readiness.read',
          'ld-reporting.report.read',
      ...
      {
        slug: 'ld-reporting.trainer',
        description: 'Read masked L&D report views scoped to courses taught by the trainer',
        permissions: [
          'ld-reporting.read',
          'ld-reporting.readiness.read',
          'ld-reporting.report.read',
      ...
      {
        slug: 'ld-reporting.trainee',
        description: 'No access to L&D reporting dashboards or report artifacts',
        permissions: [],
      },
    ],
  },
